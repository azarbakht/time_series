...
Residuals from the linear regression model shows AR(1) temporal correlation remaining. So, I fit a gls model with AR(1) component. The residuals from this gls harmonic regression model with an AR(1) component looks good, because it looks like white noise, which shows there's no evidence of remaining autocorrelation. 
